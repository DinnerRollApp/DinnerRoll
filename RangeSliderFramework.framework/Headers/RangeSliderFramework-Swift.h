...
SWIFT_MODULE_NAMESPACE_PUSH("RangeSliderFramework")
@class UIColor;
@class NSCoder;
@class CALayer;
@class UITouch;
...
SWIFT_CLASS("_TtC20RangeSliderFramework11RangeSlider")
...
@property (nonatomic, strong) UIColor * _Nonnull thumbBorderColor;
